...
$cons="SELECT COUNT(question.questionId) as preguntas, DAY(date) as dia FROM question WHERE MONTH(date) = MONTH(CURRENT_DATE()) AND YEAR(date) = YEAR(CURRENT_DATE()) GROUP BY DAY(date)";
