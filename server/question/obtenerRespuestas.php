...
$cons="SELECT answerId, answer.text, score, name, answer.date from answer, user, question where answer.questionId = $id and  user.userId = answer.userId group by answerId order by score";
